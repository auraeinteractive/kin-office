(function() {
    console.log('kinoffice_docs app direct entry 20260604-cache16', window.location.href);
    import('../kinoffice_common/office_app.js?kinOfficeBuild=20260604-cache16')
        .then(function(mod) {
